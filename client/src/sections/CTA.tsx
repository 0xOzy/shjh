  ...
  const socialLinks = [
    {
      ...
      href: "https://twitter.com/ShojoAI"
    },
    {
      name: "GitHub",
      icon: (
            ...
            <CyberpunkCTACard>
              <div className="text-center relative z-10">
                <h2 className="text-3xl md:text-4xl font-bold mb-6 font-display text-white">
                  Join the <BinaryText className="text-neon-blue">Shojo</BinaryText> AI Research
                </h2>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
                  ...
                  <NeonButton href="/documentation" className="px-8 py-4">
                    View Documentation
                  </NeonButton>
                </div>
